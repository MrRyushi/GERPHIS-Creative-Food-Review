  ...
  return (
    <div className="bg-gradient-to-t from-gradient1 to-gradient2 overflow-hidden xl:h-screen">
      ...
      <div className="pt-12 md:pt-24 xl:pt-16 pb-36 space-y-12 px-4 sm:px-0">
        ...
        {/* Main */}
        <motion.div className="grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 grid-flow-row justify-center items-center figtree px-2 md:px-12 lg:px-auto xl:px-36 gap-4 md:gap-4 lg:gap-4 xl:gap-8 xl:pt-8"
          initial="hidden"
          animate="visible"
          variants={{
            hidden: { opacity: 0 },
